...
function Page() {
    ...
    useEffect(() => {
        const fetchCartItems = async () => {
            try {
                const response = await axios.get('/api/cart/get'); // Your API endpoint to fetch cart items
    ...
    // const amount = totalPrice ?? 1; // Default to 1 if totalPrice is not available
    // console.log(amount)
