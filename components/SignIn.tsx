...
export default function LoginForm() {
    ...
    const login = async (e: any) => {
        ...
        const login = await signIn("credentials", {
            email, password, name, redirect: false
        });
    ...
    return (
        <>
            ...
            <form className="signin-form">
                ...
                <div className="flex-column">
                    ...
                    <div className="inputForm">
                        ...
                        <input value={email}
                            ...
                            disabled={loading}
                            required
                            autoComplete="email" type="email" className="input" placeholder="Enter your Email" />
                    </div>
                </div>
                <div className="flex-column">
                    ...
                    <div className="inputForm">
                        ...
                        <input value={password}
                            ...
                            type='password'
                            required
                            autoComplete="current-password" className="input" placeholder="Enter your Password" />
                ...
                <button onClick={login} className="button-submit">Sign In</button>
